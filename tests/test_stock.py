...
def test_one_stock_one_vend(client: FlaskClient):
...
def test_all_stock_one_vend(client: FlaskClient):
...
def test_add_stock2(client: FlaskClient):
...
def test_add_stock3(client: FlaskClient):
...
def test_add_stock4(client: FlaskClient):
...
def test_edit_stock2(client: FlaskClient):
